...
type Bid struct {
	...
	Identity            []byte   `protobuf:"bytes,10,opt,name=identity,proto3" json:"identity,omitempty"`
...
func (x *CommitmentInfoResponse_Commitment) GetIdentity() []byte {
	if x != nil {
		return x.Identity
	}
	return nil
...
var file_providerapi_v1_providerapi_proto_rawDesc = []byte{
	...
	0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0c, 0x42,
	...
	0x74, 0x79, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0c, 0x42, 0x37, 0x92, 0x41, 0x34, 0x32, 0x32, 0x49,
